                ...
                [
                    [
                        InlineKeyboardButton("Owner of The Bot",
                                             url="https://t.me/MotionPicturerequest2")
                    ],
                    [
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://telegram.org/mhjoy99")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("Go Home", callback_data="gotohome")
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Request Group", url="https://t.me/+X23-MlAMrIhkMWQ1"),
                        InlineKeyboardButton("Main Channel", url="https://t.me/+IkAcyhty4PY1NWY1")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs")
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/mhjoybots).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
